...
public class Maps {
        ...
        static {
                ...
                relationshipDeleterMap.put("stars",
                                "delete or rollback from stars where Creator_ID = ? and Item_ID = ?;");
                relationshipDeleterMap.put("writes",
                                "delete or rollback from writes where Creator_ID = ? and Item_ID = ?;");
                relationshipDeleterMap.put("interviewed",
                                "delete or rollback from interviewed where Creator_ID = ? and Item_ID = ?;");
                relationshipDeleterMap.put("performs",
                                "delete or rollback from performs where Creator_ID = ? and Item_ID = ?;");
                relationshipDeleterMap.put("directs",
                                "delete or rollback from directs where Creator_ID = ? and Item_ID = ?;");
